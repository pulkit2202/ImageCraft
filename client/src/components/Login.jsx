  ...
  return (
    <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
        ...
        className='relative bg-white p-10 rounded-xl text-slate-500' action="">
           ...
           { state!=='Login' && <div className='border px-6 py-2 flex items-start gap-2 rounded-full mt-5'>
            ...
            <div className='border px-6 py-2 flex items-start gap-2 rounded-full mt-4'>
                <img width={22} src={assets.email_icon} alt="" />
            ...
            <button className='
            bg-blue-600 w-full text-white rounded-full py-2' >{state === 'Login'?'login':'create account'}</button>
